...
import br.com.dextra.curso.bank.interceptors.AccountTaxStatelessInterceptor;
import br.com.dextra.curso.bank.util.JMSSenderUtil;

@Stateless
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class AccountStatelessServiceBean implements
		AccountStatelessServiceLocal, AccountStatelessServiceRemote {
	...
	@Interceptors(AccountTaxStatelessInterceptor.class)
	...
	public List<Moviment> findMoviments(String accountNumber, Date beginDate,
			Date endDate) {

		Query eqlQuery = em.createQuery("from Moviment");
		// eqlQuery.setParameter("accountNumber", accountNumber);
		// eqlQuery.setParameter("beginDate", beginDate);
		// eqlQuery.setParameter("endDate", endDate);
